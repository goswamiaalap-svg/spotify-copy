...
function applyToMobileApp() {
    ...
    const brokenText = `// Reusable SongImage component — use this EVERYWHERE instead of raw <SongImage
    ...
    const replacement = `// Reusable SongImage component — use this EVERYWHERE instead of raw <img>:
...
function MiniPlayer({ onExpand }) {
  ...
  return (
    ...
    content = content.replace(brokenText, replacement);
